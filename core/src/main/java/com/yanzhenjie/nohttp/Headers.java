...
public class Headers extends TreeMultiValueMap<String, String> {
     ...
     * The value is {@value}.
     */
    public static final String HEAD_VALUE_CONTENT_TYPE_URL = "application/x-www-form-urlencoded";
    ...
    /**
     * {@value #HEAD_KEY_CONTENT_RANGE}.
     *
     * @return {@value #HEAD_KEY_CONTENT_RANGE}.
     */
    public String getContentRange() {
        return getValue(HEAD_KEY_CONTENT_RANGE, 0);
    }
